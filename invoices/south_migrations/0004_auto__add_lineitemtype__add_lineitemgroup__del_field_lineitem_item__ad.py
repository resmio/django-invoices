...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('invoices_lineitemtype', (
        ...
        db.send_create_signal('invoices', ['LineItemType'])

        # Adding model 'LineItemGroup'
        db.create_table('invoices_lineitemgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='line_item_groups', to=orm['invoices.Item'])),
            ('item_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='line_item_groups', to=orm['invoices.LineItemType'])),
            ('amount', self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=7, decimal_places=2)),
        ))
        db.send_create_signal('invoices', ['LineItemGroup'])

        # Adding field 'LineItem.item_group'
        db.add_column('invoices_lineitem', 'item_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='line_items', null=True, to=orm['invoices.LineItemGroup']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'LineItemType'
        db.delete_table('invoices_lineitemtype')

        # Deleting model 'LineItemGroup'
        db.delete_table('invoices_lineitemgroup')

        # Deleting field 'LineItem.item_group'
        db.delete_column('invoices_lineitem', 'item_group_id')
