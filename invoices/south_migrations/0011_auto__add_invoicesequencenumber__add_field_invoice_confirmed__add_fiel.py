...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InvoiceSequenceNumber'
        db.create_table('invoices_invoicesequencenumber', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('invoices', ['InvoiceSequenceNumber'])

        # Adding field 'Invoice.confirmed'
        db.add_column('invoices_invoice', 'confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Invoice.sequence_number'
    ...
    def backwards(self, orm):
        # Deleting model 'InvoiceSequenceNumber'
        db.delete_table('invoices_invoicesequencenumber')

        # Deleting field 'Invoice.confirmed'
        db.delete_column('invoices_invoice', 'confirmed')

        # Deleting field 'Invoice.sequence_number'
        db.delete_column('invoices_invoice', 'sequence_number')
