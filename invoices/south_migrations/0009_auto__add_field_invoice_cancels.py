...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.cancels'
        db.add_column('invoices_invoice', 'cancels',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['invoices.Invoice'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.cancels'
        db.delete_column('invoices_invoice', 'cancels_id')
