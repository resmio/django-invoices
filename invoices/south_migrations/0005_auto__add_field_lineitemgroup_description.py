...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LineItemGroup.description'
        db.add_column('invoices_lineitemgroup', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'LineItemGroup.description'
        db.delete_column('invoices_lineitemgroup', 'description')
