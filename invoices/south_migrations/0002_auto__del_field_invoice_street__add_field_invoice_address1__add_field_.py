...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Invoice.street'
        db.delete_column('invoices_invoice', 'street')

        # Adding field 'Invoice.address1'
        db.add_column('invoices_invoice', 'address1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)

        # Adding field 'Invoice.address2'
        db.add_column('invoices_invoice', 'address2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Invoice.street'
        db.add_column('invoices_invoice', 'street',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)

        # Deleting field 'Invoice.address1'
        db.delete_column('invoices_invoice', 'address1')

        # Deleting field 'Invoice.address2'
        db.delete_column('invoices_invoice', 'address2')
