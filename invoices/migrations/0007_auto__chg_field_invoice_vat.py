...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invoice.vat'
        db.alter_column('invoices_invoice', 'vat', self.gf('django.db.models.fields.PositiveIntegerField')())
    def backwards(self, orm):

        # Changing field 'Invoice.vat'
        db.alter_column('invoices_invoice', 'vat', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))
    models = {
        'auth.group': {
