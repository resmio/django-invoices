...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.credit'
        db.add_column(u'invoices_invoice', 'credit',
                      self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=7, decimal_places=2),
                      keep_default=False)

        # Adding field 'Invoice.credit_reason'
        db.add_column(u'invoices_invoice', 'credit_reason',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.credit'
        db.delete_column(u'invoices_invoice', 'credit')

        # Deleting field 'Invoice.credit_reason'
        db.delete_column(u'invoices_invoice', 'credit_reason')
    ...
    models = {
        ...
        u'invoices.invoice': {
            ...
            'cancels': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['invoices.Invoice']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
